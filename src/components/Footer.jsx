    ...
    return (
        <>
            <div className='flex items-center justify-center h-80 md:h-52 bg-stone-950 text-white'>
                <div className='flex flex-col md:flex-row justify-between h-4/6 md:w-90 w-93 gap-6'>
                    <div className='flex flex-col md:w-1/4 space-y-4'>
                        ...
                        <p className='italic text-xs md:text-sm text-white'>The relationship between an artist and collector should be just that... a relationship.</p>
                    </div>
